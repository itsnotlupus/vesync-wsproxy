...
function startWebsocketProxy(localPort, localPath, remoteUrl) {
    ...
    wss.on('connection', function (local_ws) {
        ...
        local_ws.on('message', function (message) {
            if (!state) {
        ...
        remote_ws.on('open', function () {
            ...
            remote_ready = true;
            remote_ws.on('message', function (message) {
        ...
        function cleanup(code, description) {
            if (code || description) {
